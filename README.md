...
- настройки sidecar-файлов, контроля фильтра, временных параметров, размытия
  и компрессии звука;
- экспорт диагностического ZIP с защищёнными псевдонимами путей.
...
Полный формат сохранения — `*.censor.txt`. SRT и WebVTT доступны как экспорт
копии: они не содержат метаданные расписания и не отмечают черновик
сохранённым. При ручном импорте SRT или WebVTT проигрыватель отдельно
